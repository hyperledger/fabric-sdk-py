...
class OpenchainStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetBlockchainInfo = channel.unary_unary(
        ...
        response_deserializer=fabric__pb2.BlockchainInfo.FromString,
        )
    self.GetBlockByNumber = channel.unary_unary(
        '/protos.Openchain/GetBlockByNumber',
        request_serializer=BlockNumber.SerializeToString,
        response_deserializer=fabric__pb2.Block.FromString,
        )
    self.GetBlockCount = channel.unary_unary(
        '/protos.Openchain/GetBlockCount',
        request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
        response_deserializer=BlockCount.FromString,
        )
    self.GetPeers = channel.unary_unary(
        '/protos.Openchain/GetPeers',
        request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
        response_deserializer=fabric__pb2.PeersMessage.FromString,
        )


class OpenchainServicer(object):
  """Interface exported by the server.
  """
...
def add_OpenchainServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetBlockchainInfo': grpc.unary_unary_rpc_method_handler(
          servicer.GetBlockchainInfo,
          request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
          response_serializer=fabric__pb2.BlockchainInfo.SerializeToString,
      ),
      'GetBlockByNumber': grpc.unary_unary_rpc_method_handler(
          servicer.GetBlockByNumber,
          request_deserializer=BlockNumber.FromString,
          response_serializer=fabric__pb2.Block.SerializeToString,
      ),
      'GetBlockCount': grpc.unary_unary_rpc_method_handler(
          servicer.GetBlockCount,
          request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
          response_serializer=BlockCount.SerializeToString,
      ),
      'GetPeers': grpc.unary_unary_rpc_method_handler(
          servicer.GetPeers,
          request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
          response_serializer=fabric__pb2.PeersMessage.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'protos.Openchain', rpc_method_handlers)
...
class BetaOpenchainStub(object):
  """Interface exported by the server.
  """
  def GetBlockchainInfo(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """GetBlockchainInfo returns information about the blockchain ledger such as
    height, current block hash, and previous block hash.
    """
    raise NotImplementedError()
  GetBlockchainInfo.future = None
  def GetBlockByNumber(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """GetBlockByNumber returns the data contained within a specific block in the
    blockchain. The genesis block is block zero.
    """
    raise NotImplementedError()
  GetBlockByNumber.future = None
  def GetBlockCount(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """GetBlockCount returns the current number of blocks in the blockchain data
    structure.
    """
    raise NotImplementedError()
  GetBlockCount.future = None
  def GetPeers(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """GetPeers returns a list of all peer nodes currently connected to the target
    peer.
    """
    raise NotImplementedError()
...
def beta_create_Openchain_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  request_deserializers = {
    ('protos.Openchain', 'GetBlockByNumber'): BlockNumber.FromString,
    ('protos.Openchain', 'GetBlockCount'): google_dot_protobuf_dot_empty__pb2.Empty.FromString,
    ('protos.Openchain', 'GetBlockchainInfo'): google_dot_protobuf_dot_empty__pb2.Empty.FromString,
    ('protos.Openchain', 'GetPeers'): google_dot_protobuf_dot_empty__pb2.Empty.FromString,
  }
  response_serializers = {
    ('protos.Openchain', 'GetBlockByNumber'): fabric__pb2.Block.SerializeToString,
    ('protos.Openchain', 'GetBlockCount'): BlockCount.SerializeToString,
    ('protos.Openchain', 'GetBlockchainInfo'): fabric__pb2.BlockchainInfo.SerializeToString,
    ('protos.Openchain', 'GetPeers'): fabric__pb2.PeersMessage.SerializeToString,
  }
...
def beta_create_Openchain_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  request_serializers = {
    ('protos.Openchain', 'GetBlockByNumber'): BlockNumber.SerializeToString,
    ('protos.Openchain', 'GetBlockCount'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
    ('protos.Openchain', 'GetBlockchainInfo'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
    ('protos.Openchain', 'GetPeers'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
  }
  response_deserializers = {
    ('protos.Openchain', 'GetBlockByNumber'): fabric__pb2.Block.FromString,
    ('protos.Openchain', 'GetBlockCount'): BlockCount.FromString,
    ('protos.Openchain', 'GetBlockchainInfo'): fabric__pb2.BlockchainInfo.FromString,
    ('protos.Openchain', 'GetPeers'): fabric__pb2.PeersMessage.FromString,
  }
  cardinalities = {
