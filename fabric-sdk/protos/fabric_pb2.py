...
_TRANSACTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='txid', full_name='protos.Transaction.txid', index=4,
...
_TRANSACTIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='txid', full_name='protos.TransactionResult.txid', index=0,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='chaincodeEvent', full_name='protos.TransactionResult.chaincodeEvent', index=4,
...
_NONHASHDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='chaincodeEvents', full_name='protos.NonHashData.chaincodeEvents', index=1,
...
_PEERSADDRESSES = _descriptor.Descriptor(
  name='PeersAddresses',
  full_name='protos.PeersAddresses',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='addresses', full_name='protos.PeersAddresses.addresses', index=0,
...
_SYNCBLOCKRANGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='correlationId', full_name='protos.SyncBlockRange.correlationId', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='start', full_name='protos.SyncBlockRange.start', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='end', full_name='protos.SyncBlockRange.end', index=2,
...
_TRANSACTIONRESULT.fields_by_name['chaincodeEvent'].message_type = chaincodeevent__pb2._CHAINCODEEVENT
...
_NONHASHDATA.fields_by_name['chaincodeEvents'].message_type = chaincodeevent__pb2._CHAINCODEEVENT
...
class BetaPeerStub(object):
  ...
  def ProcessTransaction(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """Process a transaction from a remote source.
    """
    raise NotImplementedError()
...
def beta_create_Peer_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  request_deserializers = {
    ('protos.Peer', 'Chat'): Message.FromString,
    ('protos.Peer', 'ProcessTransaction'): Transaction.FromString,
  }
  response_serializers = {
    ('protos.Peer', 'Chat'): Message.SerializeToString,
    ('protos.Peer', 'ProcessTransaction'): Response.SerializeToString,
  }
...
def beta_create_Peer_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  request_serializers = {
    ('protos.Peer', 'Chat'): Message.SerializeToString,
    ('protos.Peer', 'ProcessTransaction'): Transaction.SerializeToString,
  }
  response_deserializers = {
    ('protos.Peer', 'Chat'): Message.FromString,
    ('protos.Peer', 'ProcessTransaction'): Response.FromString,
  }
  cardinalities = {
