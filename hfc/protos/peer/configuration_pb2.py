...
_ANCHORPEERS = _descriptor.Descriptor(
  name='AnchorPeers',
  full_name='hfc.protos.peer.AnchorPeers',
  filename=None,
  file=DESCRIPTOR,
...
_ANCHORPEER = _descriptor.Descriptor(
  name='AnchorPeer',
  full_name='hfc.protos.peer.AnchorPeer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
AnchorPeers = _reflection.GeneratedProtocolMessageType('AnchorPeers', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:hfc.protos.peer.AnchorPeers)
  ))
...
AnchorPeer = _reflection.GeneratedProtocolMessageType('AnchorPeer', (_message.Message,), dict(
  ...
  __module__ = 'hfc.protos.peer.configuration_pb2'
  # @@protoc_insertion_point(class_scope:hfc.protos.peer.AnchorPeer)
  ))
