...
_CHAINCODESPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ctorMsg', full_name='hfc.protos.peer.ChaincodeSpec.ctorMsg', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='confidentialityLevel', full_name='hfc.protos.peer.ChaincodeSpec.confidentialityLevel', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='hfc.protos.peer.ChaincodeSpec.metadata', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='hfc.protos.peer.ChaincodeSpec.attributes', index=6,
...
_CHAINCODEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='chaincodeEvent', full_name='hfc.protos.peer.ChaincodeMessage.chaincodeEvent', index=4,
...
_RANGEQUERYSTATENEXT = _descriptor.Descriptor(
  ...
  full_name='hfc.protos.peer.RangeQueryStateNext',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ID', full_name='hfc.protos.peer.RangeQueryStateNext.ID', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RANGEQUERYSTATECLOSE = _descriptor.Descriptor(
  ...
  full_name='hfc.protos.peer.RangeQueryStateClose',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ID', full_name='hfc.protos.peer.RangeQueryStateClose.ID', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RANGEQUERYSTATEKEYVALUE = _descriptor.Descriptor(
  ...
  full_name='hfc.protos.peer.RangeQueryStateKeyValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='hfc.protos.peer.RangeQueryStateKeyValue.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='hfc.protos.peer.RangeQueryStateKeyValue.value', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RANGEQUERYSTATERESPONSE = _descriptor.Descriptor(
  ...
  full_name='hfc.protos.peer.RangeQueryStateResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keysAndValues', full_name='hfc.protos.peer.RangeQueryStateResponse.keysAndValues', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hasMore', full_name='hfc.protos.peer.RangeQueryStateResponse.hasMore', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ID', full_name='hfc.protos.peer.RangeQueryStateResponse.ID', index=2,
...
RangeQueryStateNext = _reflection.GeneratedProtocolMessageType('RangeQueryStateNext', (_message.Message,), dict(
  ...
  __module__ = 'hfc.protos.peer.chaincode_pb2'
  # @@protoc_insertion_point(class_scope:hfc.protos.peer.RangeQueryStateNext)
  ))
...
RangeQueryStateClose = _reflection.GeneratedProtocolMessageType('RangeQueryStateClose', (_message.Message,), dict(
  ...
  __module__ = 'hfc.protos.peer.chaincode_pb2'
  # @@protoc_insertion_point(class_scope:hfc.protos.peer.RangeQueryStateClose)
  ))
...
RangeQueryStateKeyValue = _reflection.GeneratedProtocolMessageType('RangeQueryStateKeyValue', (_message.Message,), dict(
  ...
  __module__ = 'hfc.protos.peer.chaincode_pb2'
  # @@protoc_insertion_point(class_scope:hfc.protos.peer.RangeQueryStateKeyValue)
  ))
...
RangeQueryStateResponse = _reflection.GeneratedProtocolMessageType('RangeQueryStateResponse', (_message.Message,), dict(
  ...
  __module__ = 'hfc.protos.peer.chaincode_pb2'
  # @@protoc_insertion_point(class_scope:hfc.protos.peer.RangeQueryStateResponse)
  ))
