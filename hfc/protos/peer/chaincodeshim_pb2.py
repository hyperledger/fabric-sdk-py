...
# source: hfc/protos/peer/chaincodeshim.proto
...
_CHAINCODEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='proposal', full_name='hfc.protos.peer.ChaincodeMessage.proposal', index=4,
...
_GETHISTORYFORKEY = _descriptor.Descriptor(
  ...
  full_name='hfc.protos.peer.GetHistoryForKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='hfc.protos.peer.GetHistoryForKey.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CHAINCODEMESSAGE.fields_by_name['proposal'].message_type = hfc_dot_protos_dot_peer_dot_proposal__pb2._PROPOSAL
...
ChaincodeMessage = _reflection.GeneratedProtocolMessageType('ChaincodeMessage', (_message.Message,), dict(
  ...
  __module__ = 'hfc.protos.peer.chaincodeshim_pb2'
...
GetHistoryForKey = _reflection.GeneratedProtocolMessageType('GetHistoryForKey', (_message.Message,), dict(
  ...
  __module__ = 'hfc.protos.peer.chaincodeshim_pb2'
  # @@protoc_insertion_point(class_scope:hfc.protos.peer.GetHistoryForKey)
  ))
