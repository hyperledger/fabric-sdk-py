...
_CONNESTABLISH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='probe', full_name='gossip.ConnEstablish.probe', index=3,
...
_PRIVATEPAYLOAD.fields_by_name['collection_configs'].message_type = hfc_dot_protos_dot_peer_dot_collection__pb2._COLLECTIONCONFIGPACKAGE
