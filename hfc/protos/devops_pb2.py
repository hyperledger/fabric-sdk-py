...
class DevopsStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Login = channel.unary_unary(
        '/protos.Devops/Login',
        request_serializer=Secret.SerializeToString,
        response_deserializer=fabric__pb2.Response.FromString,
        )
    self.Build = channel.unary_unary(
        '/protos.Devops/Build',
        request_serializer=chaincode__pb2.ChaincodeSpec.SerializeToString,
        response_deserializer=chaincode__pb2.ChaincodeDeploymentSpec.FromString,
        )
    ...
    self.Invoke = channel.unary_unary(
        ...
        request_serializer=chaincode__pb2.ChaincodeInvocationSpec.SerializeToString,
        response_deserializer=fabric__pb2.Response.FromString,
        )
    ...
    self.EXP_GetApplicationTCert = channel.unary_unary(
        '/protos.Devops/EXP_GetApplicationTCert',
        request_serializer=Secret.SerializeToString,
        response_deserializer=fabric__pb2.Response.FromString,
        )
    self.EXP_PrepareForTx = channel.unary_unary(
        '/protos.Devops/EXP_PrepareForTx',
        request_serializer=Secret.SerializeToString,
        response_deserializer=fabric__pb2.Response.FromString,
        )
    self.EXP_ProduceSigma = channel.unary_unary(
        '/protos.Devops/EXP_ProduceSigma',
        request_serializer=SigmaInput.SerializeToString,
        response_deserializer=fabric__pb2.Response.FromString,
        )
    self.EXP_ExecuteWithBinding = channel.unary_unary(
        '/protos.Devops/EXP_ExecuteWithBinding',
        request_serializer=ExecuteWithBinding.SerializeToString,
        response_deserializer=fabric__pb2.Response.FromString,
        )


class DevopsServicer(object):
  """Interface exported by the server.
  """
...
def add_DevopsServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'Build': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=chaincode__pb2.ChaincodeDeploymentSpec.SerializeToString,
      ),
      ...
      'Invoke': grpc.unary_unary_rpc_method_handler(
          servicer.Invoke,
          request_deserializer=chaincode__pb2.ChaincodeInvocationSpec.FromString,
          response_serializer=fabric__pb2.Response.SerializeToString,
      ),
      ...
      'EXP_GetApplicationTCert': grpc.unary_unary_rpc_method_handler(
          servicer.EXP_GetApplicationTCert,
          request_deserializer=Secret.FromString,
          response_serializer=fabric__pb2.Response.SerializeToString,
      ),
      'EXP_PrepareForTx': grpc.unary_unary_rpc_method_handler(
          servicer.EXP_PrepareForTx,
          request_deserializer=Secret.FromString,
          response_serializer=fabric__pb2.Response.SerializeToString,
      ),
      'EXP_ProduceSigma': grpc.unary_unary_rpc_method_handler(
          servicer.EXP_ProduceSigma,
          request_deserializer=SigmaInput.FromString,
          response_serializer=fabric__pb2.Response.SerializeToString,
      ),
      'EXP_ExecuteWithBinding': grpc.unary_unary_rpc_method_handler(
...
class BetaDevopsStub(object):
  ...
  Login.future = None
  def Build(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """Build the chaincode package.
    """
    raise NotImplementedError()
  Build.future = None
  def Deploy(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    ...
    raise NotImplementedError()
  Deploy.future = None
  def Invoke(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """Invoke chaincode.
    """
    raise NotImplementedError()
  Invoke.future = None
  def Query(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    ...
    raise NotImplementedError()
  Query.future = None
  def EXP_GetApplicationTCert(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """Retrieve a TCert.
    """
    raise NotImplementedError()
  EXP_GetApplicationTCert.future = None
  def EXP_PrepareForTx(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """Prepare for performing a TX, which will return a binding that can later be used to sign and then execute a transaction.
    """
    raise NotImplementedError()
  EXP_PrepareForTx.future = None
  def EXP_ProduceSigma(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """Prepare for performing a TX, which will return a binding that can later be used to sign and then execute a transaction.
    """
    raise NotImplementedError()
  EXP_ProduceSigma.future = None
  def EXP_ExecuteWithBinding(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    """Execute a transaction with a specific binding
    """
    raise NotImplementedError()
...
def beta_create_Devops_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  request_deserializers = {
    ('protos.Devops', 'Build'): chaincode__pb2.ChaincodeSpec.FromString,
    ('protos.Devops', 'Deploy'): chaincode__pb2.ChaincodeSpec.FromString,
    ('protos.Devops', 'EXP_ExecuteWithBinding'): ExecuteWithBinding.FromString,
    ('protos.Devops', 'EXP_GetApplicationTCert'): Secret.FromString,
    ('protos.Devops', 'EXP_PrepareForTx'): Secret.FromString,
    ('protos.Devops', 'EXP_ProduceSigma'): SigmaInput.FromString,
    ('protos.Devops', 'Invoke'): chaincode__pb2.ChaincodeInvocationSpec.FromString,
    ('protos.Devops', 'Login'): Secret.FromString,
    ('protos.Devops', 'Query'): chaincode__pb2.ChaincodeInvocationSpec.FromString,
  }
  response_serializers = {
    ('protos.Devops', 'Build'): chaincode__pb2.ChaincodeDeploymentSpec.SerializeToString,
    ('protos.Devops', 'Deploy'): chaincode__pb2.ChaincodeDeploymentSpec.SerializeToString,
    ('protos.Devops', 'EXP_ExecuteWithBinding'): fabric__pb2.Response.SerializeToString,
    ('protos.Devops', 'EXP_GetApplicationTCert'): fabric__pb2.Response.SerializeToString,
    ('protos.Devops', 'EXP_PrepareForTx'): fabric__pb2.Response.SerializeToString,
    ('protos.Devops', 'EXP_ProduceSigma'): fabric__pb2.Response.SerializeToString,
    ('protos.Devops', 'Invoke'): fabric__pb2.Response.SerializeToString,
    ('protos.Devops', 'Login'): fabric__pb2.Response.SerializeToString,
    ('protos.Devops', 'Query'): fabric__pb2.Response.SerializeToString,
  }
...
def beta_create_Devops_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  request_serializers = {
    ('protos.Devops', 'Build'): chaincode__pb2.ChaincodeSpec.SerializeToString,
    ('protos.Devops', 'Deploy'): chaincode__pb2.ChaincodeSpec.SerializeToString,
    ('protos.Devops', 'EXP_ExecuteWithBinding'): ExecuteWithBinding.SerializeToString,
    ('protos.Devops', 'EXP_GetApplicationTCert'): Secret.SerializeToString,
    ('protos.Devops', 'EXP_PrepareForTx'): Secret.SerializeToString,
    ('protos.Devops', 'EXP_ProduceSigma'): SigmaInput.SerializeToString,
    ('protos.Devops', 'Invoke'): chaincode__pb2.ChaincodeInvocationSpec.SerializeToString,
    ('protos.Devops', 'Login'): Secret.SerializeToString,
    ('protos.Devops', 'Query'): chaincode__pb2.ChaincodeInvocationSpec.SerializeToString,
  }
  response_deserializers = {
    ('protos.Devops', 'Build'): chaincode__pb2.ChaincodeDeploymentSpec.FromString,
    ('protos.Devops', 'Deploy'): chaincode__pb2.ChaincodeDeploymentSpec.FromString,
    ('protos.Devops', 'EXP_ExecuteWithBinding'): fabric__pb2.Response.FromString,
    ('protos.Devops', 'EXP_GetApplicationTCert'): fabric__pb2.Response.FromString,
    ('protos.Devops', 'EXP_PrepareForTx'): fabric__pb2.Response.FromString,
    ('protos.Devops', 'EXP_ProduceSigma'): fabric__pb2.Response.FromString,
    ('protos.Devops', 'Invoke'): fabric__pb2.Response.FromString,
    ('protos.Devops', 'Login'): fabric__pb2.Response.FromString,
    ('protos.Devops', 'Query'): fabric__pb2.Response.FromString,
  }
  cardinalities = {
