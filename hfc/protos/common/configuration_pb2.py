...
from common import chain_config_pb2 as common_dot_chain__config__pb2
...
_SIGNATUREPOLICYENVELOPE.fields_by_name['Identities'].message_type = common_dot_chain__config__pb2._MSPPRINCIPAL
